...
// ✅ Cálculo manual de semana ISO 8601 - 100% preciso
...
function loadMealsGrid(user) {
  ...
  const render = () => {
    ...
    // ✅ Depuración: Verifica que es correcto
    console.log("Semana seleccionada:", weekInput.value);
    console.log("Lunes calculado:", weekDate.toDateString());
