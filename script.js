...
function initResidenteAuth() {
  ...
  // ✅ Siempre mostrar el modal: no recordar sesión
...
function loadMealsGrid(user) {
  ...
  const summaryContainer = document.getElementById("meals-summary-container");
  if (!summaryContainer) {
    const container = document.createElement("div");
    container.id = "meals-summary-container";
  ...
  const render = () => {
    ...
    // ✅ Mostrar resumen de comidas registradas
...
// ✅ Nueva función: actualiza el resumen de comidas
