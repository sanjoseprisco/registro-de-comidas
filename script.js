...
function showSection(id) {
  ...
  document.getElementById("residente-modal").style.display = "none";
  document.getElementById("cocinero-modal").style.display = "none";
...
function initResidenteModal() {
  ...
  document.getElementById("submit-residente").addEventListener("click", () => {
...
// === COCINERO: ACCESO CON CLAVE 12345 ===
function initCocineroModal() {
  ...
  document.getElementById("submit-chef").addEventListener("click", () => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("btn-residente").addEventListener("click", initResidenteModal);
  document.getElementById("btn-cocinero").addEventListener("click", initCocineroModal);
